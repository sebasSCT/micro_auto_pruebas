...
Scenario: Se quiere actualizar un perfil con el servicio de gestion de perfiles
    Given Usuario con credenciales validas, email "usuario@example.com", contraseña "password123", y los datos a actualizar, id del usuario "6735fff9cf62612bf7145044", el nickmane o apodo "actu_user_example", la url personal "https://user.com", la direccion "calle 0 avenida 0", su biografia "user biography", la organizacion del usuario "exampleCorp", el pais del usuario "EXAMPLE", links a las redes sociales "https://linkedin.com/in/user_example" y la identificacion "6735fff9cf62612bf7145044"
